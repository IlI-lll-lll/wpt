...
const tests = [
  ...
  {
    name:
        'Throw if inputShapeA[1] is not equal to inputShapeB[1] with bTranspose=true.',
    a: {dataType: 'float32', dimensions: [2, 3]},
    b: {dataType: 'float32', dimensions: [3, 4]},
    options: {
      bTranspose: true,
  ...
  },
  {
    ...
    a: {dataType: 'float32', dimensions: [kMaxUnsignedLong, 2]},
    b: {dataType: 'float32', dimensions: [2, kMaxUnsignedLong]},
  },
];
