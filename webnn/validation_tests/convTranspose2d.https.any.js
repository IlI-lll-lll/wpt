...
const tests = [
  ...
  {
    name: 'Throw if the input channels is not equal to the filter input channels with inputLayout="nchw" and filterLayout="iohw".',
  ...
  {
    name:
        'Throw if the input channels is not equal to the filter input channels with inputLayout="nchw" and filterLayout="hwoi".',
    input: {dataType: 'float32', dimensions: [1, 3, 3, 3]},
  ...
  {
    name:
        'Throw if the input channels is not equal to the filter input channels with inputLayout="nchw" and filterLayout="ohwi".',
  ...
  {
    name:
        'Throw if the input channels is not equal to the filter input channels with inputLayout="nhwc" and filterLayout="iohw".',
  ...
  {
    name:
        'Throw if the input channels is not equal to the filter input channels inputLayout="nhwc" and filterLayout="hwoi".',
    input: {dataType: 'float32', dimensions: [1, 3, 3, 2]},
    filter: {dataType: 'float32', dimensions: [3, 3, 2, 1]},
    options: {
      filterLayout: 'hwoi',
  ...
  {
    name:
        'Throw if the input channels is not equal to the filter input channels with inputLayout="nhwc" and filterLayout="ohwi".',
    input: {dataType: 'float32', dimensions: [1, 3, 3, 2]},
    filter: {dataType: 'float32', dimensions: [2, 3, 3, 1]},
    options: {
      filterLayout: 'ohwi',
  ...
  {
    name: 'Throw due to overflow when dilation height is too large.',
    input: {dataType: 'float32', dimensions: [1, 1, 5, 5]},
  ...
  {
    name: 'Throw due to overflow when dilation width is too large.',
    input: {dataType: 'float32', dimensions: [1, 1, 5, 5]},
    filter: {dataType: 'float32', dimensions: [1, 1, 3, 2]},
    options: {
  ...
  {
    name: 'Throw if the bias shape is not equal to [output_channels] with filterLayout="iohw".',
    input: {dataType: 'float32', dimensions: [1, 1, 5, 5]},
    filter: {dataType: 'float32', dimensions: [1, 1, 2, 2]},
    options: {
      filterLayout: "iohw",
  ...
  {
    name: 'Throw if the bias shape is not equal to [output_channels] with filterLayout="hwoi".',
    input: {dataType: 'float32', dimensions: [1, 1, 5, 5]},
  ...
  {
    name: 'Throw if the bias shape is not equal to [output_channels] with filterLayout="ohwi".',
    input: {dataType: 'float32', dimensions: [1, 1, 5, 5]},
  ...
  {
    name:
        'Throw if the outputPadding is not smaller than stride along the width dimension.',
  ...
  {
    name:
        'Throw if the outputPadding is not smaller than stride along the height dimension.',
    input: {dataType: 'float32', dimensions: [1, 1, 2, 2]},
    filter: {dataType: 'float32', dimensions: [1, 1, 3, 3]},
    options: {
      padding: [0, 0, 3, 3],
  ...
  {
    name: 'Throw if the padding height is too large.',
    input: {dataType: 'float32', dimensions: [1, 1, 2, 2]},
    filter: {dataType: 'float32', dimensions: [1, 1, 3, 3]},
    options: {
      padding: [4, 4, 0, 0],
  ...
  {
    name: 'Throw if the padding width is too large.',
    input: {dataType: 'float32', dimensions: [1, 1, 2, 2]},
    filter: {dataType: 'float32', dimensions: [1, 1, 3, 3]},
    options: {
      padding: [0, 0, 4, 4],
